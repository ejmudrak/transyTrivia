...
function getWelcomeResponse(callback) {
    var sessionAttributes = {},
        speechOutput = "Welcome to Transylvania Trivia! I will ask you " + GAME_LENGTH.toString()
            + " questions about Transylvania University, try to get as many right as you can. Just say the number of the answer. If you need to hear a question again, just say repeat. Hail Transylvania, let's begin! ",
